...
export default function DeductSheet({ student, balance, onConfirm, onClose }) {
    ...
    <div className="action-overlay" onClick={onClose}>
      <div className="action-sheet" onClick={e => e.stopPropagation()}>
        ...
        <header className="action-sheet-header">
          <h2 className="action-sheet-title">➖ Deduct — {student}</h2>
        ...
        <div className="action-sheet-footer">
          ...
          <button className="action-confirm-btn action-confirm-btn--deduct"
